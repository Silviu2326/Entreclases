...
export async function generateMetadata({ params }: Params) { const game = gameBySlug("va", (await params).game); return game ? gameMetadata("va", false, game.id) : {}; }
export default async function Page({ params }: Params) { const game = gameBySlug("va", (await params).game); return <CommunityApp locale="va" game={game?.id ?? null} />; }
