...
export function withFakeHomeData(data: CommunityData, locale: Locale): CommunityData {
  ...
  const groups: Group[] = [
    { id: "fake-group-study", creator_id: "fake-laia", name: text("Los del tema 4", "Els del tema 4"), description: text("Apuntes, dudas y compañía para estudiar. Nadie nace sabiendo estadística.", "Apunts, dubtes i companyia per a estudiar. Ningú naix sabent estadística."), category: "study", campus: "Blasco Ibáñez", is_private: false, share_token: "fake-share-group-study", created_at: ago(40) },
    { id: "fake-group-outside", creator_id: "fake-marc", name: text("Nos vemos fuera", "Ens veiem fora"), description: text("El Turia, la playa o donde caiga. Hay vida después de las prácticas.", "El Túria, la platja o on siga. Hi ha vida després de les pràctiques."), category: "leisure", campus: "Tarongers", is_private: false, share_token: "fake-share-group-outside", created_at: ago(42) },
    { id: "fake-group-build", creator_id: "fake-nico", name: text("Gente que hace cosas", "Gent que fa coses"), description: text("Una idea, distintas carreras y ganas de probar. Empezamos en Vera.", "Una idea, carreres diferents i ganes de provar. Comencem a Vera."), category: "projects", campus: "Vera", is_private: false, share_token: "fake-share-group-build", created_at: ago(45) },
  ];
