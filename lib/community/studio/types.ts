...
export type Submission = { id: string; author: string; title: string; body: string; kind: "project" | "plan" | "post" | "initiative"; source_id: string; source_url: string; attribution: string; consent: boolean; edition_id: string | null; created_at: string };
export type StudioData = { projects: Project[]; applications: Application[]; messages: TeamMessage[]; editions: Edition[]; submissions: Submission[]; editor: boolean };
export type StudioInput = Record<string, unknown>;
export const emptyStudio = (): StudioData => ({ projects: [], applications: [], messages: [], editions: [], submissions: [], editor: false });
