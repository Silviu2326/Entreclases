...
export function Magazine() {
  ...
  return <div className={`st-page mz-magazine mz-page-${page} ${largeText?"mz-large-type":""}`} id="revista-portada" tabIndex={-1}>
    ...
    <footer className="mz-footer"><span>{t("Entre líneas.","Entre línies")} <small>× Entreclase</small></span><a href="#revista-portada" onClick={e=>{e.preventDefault();navigatePage("cover")}}>{t("Volver a portada","Tornar a portada")}<ArrowUp aria-hidden="true"/></a></footer>
  </div>;
}
